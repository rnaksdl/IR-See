...
#### for pitch_p60
```bash
python 200_batch_adjust.py ../1_angle/pitch_p60/input ../1_angle_/pitch_p60/input_e --brightness -0.8 --saturation 3.0 --blackpoint 0.50 --temp-k 18000 --probe -v
...
#### for yaw_p45
```bash
python 200_batch_adjust.py ../1_angle/yaw_p45/input ../1_angle_/yaw_p45/input_e --brightness -0.8 --saturation 3.0 --blackpoint 0.50 --temp-k 18000 --probe -v
